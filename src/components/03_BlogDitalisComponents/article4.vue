...
<template>
    <div class="article_container">
        <h2 class="h2_content_text">Все о спальне</h2>
        <div class="article_img_conteiner">
            <img src="/public/img/articleBedroom.jpg" alt="Кухня" class="article_img">
        ...
        <p class="p_article">
            ...
            consectetur, adipisci velit ...», и переводится как «Нет никого, кто любил бы свою боль, кто искал
            бы ее и хотел бы чтобы она была у него. Потому что это боль...»
        </p>
